...
import { FileText, Plus, Edit3, Trash2, Search, Moon, Smartphone, Save } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0f0f1a]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-bold text-white">
              <span className="text-neon-cyan">Dark</span>Notes — Model Overview
            </h1>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-10">
        ...
        <section className="text-center py-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-white">DarkNotes</h2>
          <p className="mt-3 text-gray-400 max-w-lg mx-auto leading-relaxed">
            A sleek, dark-themed notes application for capturing and organizing your thoughts.
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Moon, title: 'Dark Theme', desc: 'The entire interface uses a comfortable dark palette — near-black backgrounds, dark gray cards, and neon accent highlights.' },
              ...
              <div key={i} className="bg-[#1a1a2e] border border-[#2a2a3e] rounded-xl p-5">
        ...
        <section>
          ...
          <div className="bg-[#1a1a2e] border border-[#2a2a3e] rounded-xl p-5 flex items-center gap-4">
            <Smartphone className="w-6 h-6 text-neon-green flex-shrink-0" />
            <p className="text-sm text-gray-400">
              DarkNotes works on desktop and mobile. The card grid adapts from three columns on large screens to a single column on phones. The editor is full-width and comfortable to use with a touch keyboard.
            </p>
          </div>
        </section>
      </main>
